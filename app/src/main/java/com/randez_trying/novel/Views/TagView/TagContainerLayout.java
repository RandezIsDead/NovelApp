...
import static com.randez_trying.novel.Views.TagView.Utils.sp2px;
...
public class TagContainerLayout extends ViewGroup {
    ...
    private int mBorderColor = Color.parseColor("#00FF0000");
    private int mBackgroundColor = Color.parseColor("#00FF0000");
